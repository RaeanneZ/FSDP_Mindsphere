...
class Payment {
    constructor(TransacID, Email, ProgID, TotalCost, PaidDate, TransacStatus) {
    ...
    static async getTransactionById(transacID) {
        try {
            ...
            console.error(
                "ModelError: Error fetching transaction by ID:",
                error
            );
    ...
    static async makePayment(TransacID) {
        try {
            ...
            console.log(
                `Payment with TransacID: ${TransacID} updated successfully to 'Paid'.`
            );
    ...
    static async getUnpaidTransactionByEmail(email) {
        try {
            ...
            console.error(
                "ModelError: Error fetching unpaid transactions by email:",
                err
            );
